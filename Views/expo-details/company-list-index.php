...
<?php require_once("./company-list-edit.php"); ?>
<?php require_once("./company-list-add.php"); ?>
<?php require_once("./company-list-delete.php"); ?>
...
<div class="main-content w-100">
    ...
    <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./company-list-index.php"><i class="fa-solid fa-clipboard-list" data-toggle="tooltip" data-placement="top" title="Company List"></i></a>
            </li>
            <li class="nav-item">
