...
<?php require_once("./data-gathering-edit.php"); ?>
<?php require_once("./data-gathering-add.php"); ?>
<?php require_once("./data-gathering-delete.php"); ?>
...
<div class="main-content w-100">
    ...
    <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./data-gathering-index.php"><i class="fa-solid fa-file-arrow-down" data-toggle="tooltip" data-placement="top" title="Data Gathering"></i></a>
            </li>
            <li class="nav-item">
    ...
    <?php require_once "./data-gathering-filters.php"; ?>
