...
$db = new Database();
  if (isset($_POST["edit-on-site"])) {
    ...
    $db->query("SELECT requirement_id,package_id FROM expo_slots WHERE id = '$expo_s_id';");
    $db->execute();
    $row_data = $db->fetch();
...
//       $_SESSION["success-on-site"] = "Data has been updated successfully.";
                ...
                <div class="modal-body">
                  ...
                  ?>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col">
                            <label for="MOA_link">Floor Layout</label><br />
                            <div class="input-group">
