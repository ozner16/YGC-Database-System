...
if (isset($_POST['edit-ps'])) {
  ...
  $db->query("UPDATE company_update SET `company_update_name` ='$status' WHERE `id` = '$id';");
  $db->execute();
  $db->closeStmt();
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">Edit Company Update</h5>
        ...
        <div class="modal-body"> 
          ...
          <div class="row mt-2">
            ...
            <input type="hidden" id="edit_id" name="id" style="width:460px;margin-bottom:12px;">
              <label for="package_price">Company Update</label><br>
