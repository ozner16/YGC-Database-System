...
<?php require_once("./promotion-status-edit.php"); ?>
<?php require_once("./promotion-status-add.php"); ?>
<?php require_once("./promotion-status-delete.php"); ?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./promotion-status-index.php"><i class="fa-solid fa-photo-film" data-toggle="tooltip" data-placement="top" title="Promotion Status"></i></a>
            </li>
            <li class="nav-item">
...
<script>
  $(document).ready(function() {
    ...
    $(mainDataTableId).on('click', 'td.editor-edit', function (e) {
      ...
      $("#edit-promotion-status").val(rowObject['prom_status']);
