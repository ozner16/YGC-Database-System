<?php
$table_name = "Company Category Update";
session_start();
...
<?php require_once("./company-category-update-edit.php"); ?>
<?php require_once("./company-category-update-add.php"); ?>
<?php require_once("./company-category-update-delete.php"); ?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./company-category-update-index.php"><i class="fa-solid fa-square-poll-horizontal" data-toggle="tooltip" data-placement="top" title="Company Category Update"></i></a>
            </li>
            <li class="nav-item">
...
$table_structure = array(
  ...
  "columns" => json_encode(array(
    'company_update_name' => 'Company Update Category',
    'id' => '',
  ))
);
//$db->closeStmt();
...
<script>
  $(document).ready(function() {
    ...
    $(mainDataTableId).on('click', 'td.editor-edit', function (e) {
      ...
      $("#edit_category").val(rowObject['company_update_name']);
