...
<?php require_once("./podmots-category-edit.php"); ?>
<?php require_once("./podmots-category-add.php"); ?>
<?php require_once("./podmots-category-delete.php"); ?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./podmots-category-index.php"><i class="fa-solid fa-folder-tree" data-toggle="tooltip" data-placement="top" title="Publication Materials Category"></i></a>
            </li>
            <li class="nav-item">
...
<script>
  $(document).ready(function() {
    ...
    $(mainDataTableId).on('click', 'td.editor-edit', function (e) {
      ...
      $("#edit_category").val(rowObject['pubmats_cat']);
