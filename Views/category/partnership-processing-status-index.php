...
<?php require_once("./partnership-processing-status-edit.php"); ?>
<?php require_once("./partnership-processing-status-add.php"); ?>
<?php require_once("./partnership-processing-status-delete.php"); ?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./partnership-processing-status-index.php"><i class="fa-solid fa-handshake" data-toggle="tooltip" data-placement="top" title="Partnership Processing Status"></i></a>
            </li>
            <li class="nav-item">
