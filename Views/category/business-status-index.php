...
<?php require_once("./business-status-edit.php"); ?>
<?php require_once("./business-status-add.php"); ?>
<?php require_once("./business-status-delete.php"); ?>
...
<?php
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./business-status-index.php"><i class="fa-solid fa-tags" data-toggle="tooltip" data-placement="top" title="Business Status"></i></a>
            </li>
            <li class="nav-item">
