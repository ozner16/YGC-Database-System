<?php
   ...
   if (isset($_POST['edit_color'])) {
     ...
     if (sizeof($db->resultSet()) === 0){
       $db->query("UPDATE bd_status SET `status_name` ='$status', `color` ='$color' WHERE `id` = '$idedit';");
       $db->execute();
       $db->closeStmt();
       $_SESSION["success"] = "Data has been updated successfully.";
     }
     else{
       $_SESSION["failed-card"] = "Data is already in the database.";
     }
   }
   ?>
<section>
   <div class="modal fade modal-lg" id="editModal" tabindex="3" aria-labelledby="editModalLabel" aria-hidden="true">
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <form action="./bd-status-index.php" method="POST">
