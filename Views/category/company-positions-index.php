...
<?php require_once("./company-positions-edit.php"); ?>
<?php require_once("./company-positions-add.php"); ?>
<?php require_once("./company-positions-delete.php"); ?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./company-positions-index.php"><i class="fa-solid fa-user-gear" data-toggle="tooltip" data-placement="top" title="Company Positions"></i></a>
            </li>
            <li class="nav-item">
...
$db->query("SELECT * from company_positions;");
$db->execute();
...
<script>
  $(document).ready(function() {
    ...
    $(mainDataTableId).on('click', 'td.editor-edit', function (e) {
      ...
      $("#edit-company_position").val(rowObject['comp_position']);
