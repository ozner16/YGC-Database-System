...
<?php require_once("./provinces-edit.php"); ?>
<?php require_once("./provinces-add.php"); ?>
<?php require_once("./provinces-delete.php"); ?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./provinces-index.php"><i class="fa-solid fa-map-location-dot" data-toggle="tooltip" data-placement="top" title="Provinces"></i></a>
            </li>
        </ul>
    </div>
...
$db->query("SELECT refprovince.id, refprovince.provDesc, refregion.regDesc, refregion.null FROM refprovince, refregion WHERE 
refprovince.refregion_id = refregion.id;");
$db->execute();
...
<script>
  $(document).ready(function() {
    ...
    $(mainDataTableId).on('click', 'td.editor-edit', function (e) {
      ...
      $("#edit-province").val(rowObject['provDesc']);
