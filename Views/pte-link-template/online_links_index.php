...
<?php endif?>
<?php
    if (isset($_SESSION["success-online-link"])) { ?>
        <div class="alert alert-success text-success">
            <?php
            echo $_SESSION["success-online-link"];
            unset($_SESSION["success-online-link"]);
            ?>
        </div> <?php
      }
?>
...
<div class="main-content w-100">
  ...
  <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./online_links_index.php"><i class="fas fa-link" data-toggle="tooltip" data-placement="top" title="Online Links"></i></a>
            </li>
            <li class="nav-item">
  ...
  <?php require_once "./online-filters.php"; ?>
    <table id="datatable-main" class="table table-striped h-full w-full"></table>
  </div>
</div>

<?php require_once("./online_edit.php"); ?>
<?php require_once("./online_add.php"); ?>
<?php require_once("./online_delete.php"); ?>
