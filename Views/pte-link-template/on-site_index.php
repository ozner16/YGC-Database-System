...
<div class="main-content w-100">
  <h4 class="py-2"><?= $table_name ?></h4>
    ...
    <div>
        <ul class="nav nav-tabs flex-row justify-content-start">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="./on-site_index.php"><i class="fas fa-paperclip" data-toggle="tooltip" data-placement="top" title="Onsite Links"></i></a>
            </li>
            <li class="nav-item">
  ...
  <?php require_once "./on-site_filters.php"; ?>
    <table id="datatable-main" class="table table-striped h-full w-full"></table>
  </div>
</div>

<?php require_once("./on-site_edit.php"); ?>
<?php require_once("./on-site_add.php"); ?>
<?php require_once("./on-site_delete.php"); ?>
