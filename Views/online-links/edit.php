...
if (sizeof($db->resultSet()) === 0){
  ...
  $db->execute();
  $db->closeStmt();
  $_SESSION["success-online-link"] = "Online links successfully update.";
  echo '<script> window.location.href="/WSAP_DATABASE/Views/online-links/index.php" </script>';	
}else{
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="editModalLabel">Edit Online Links</h5>
      ...
      <form action="./index.php" method="post">
        <div class="modal-body"> 
          <div class="row mt-2">
            ...
            <div class="input-group">
                <select class='form-control' name="expo_name" id="expo_name" disabled>
                <?php
        ...
        <div class="modal-footer w-100">
          ...
          <button type="submit" name="edit_onsite_link" class="btn btn-primary ms-auto">Save Changes</button>
