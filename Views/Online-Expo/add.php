...
if (isset($_POST["add-online"])) {
  ...
  $sql = "INSERT INTO expo_slots (expo_id, business_id, package_link, logo_storage_for_online)VALUES( '$expo_id', '$business_id', '$package_link', '$logo_storage')";

if ($connect->query($sql) == TRUE) {
  $_SESSION["success-online"] = "Online expo successfully added.";
